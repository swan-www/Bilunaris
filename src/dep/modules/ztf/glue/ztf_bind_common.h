...
#define THE_FORGE_RELEASE_VER_MAJOR 1
#define THE_FORGE_RELEASE_VER_MINOR 57

#define ZTF_VERSION_GREATER_THAN_OR_EQUAL(InMajor, InMinor) ((InMajor >= THE_FORGE_RELEASE_VER_MAJOR) && (InMinor >= THE_FORGE_RELEASE_VER_MINOR))
