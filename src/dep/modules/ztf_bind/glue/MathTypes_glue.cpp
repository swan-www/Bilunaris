...
ztf_Int2* ztf_int2_new(int const* in_int_array)
{
	...
	return new int2(in_int_array[0], in_int_array[1]);
}
void ztf_int2_delete(ztf_Int2* in_int2) { if(in_int2){ delete static_cast<ztf_Int2*>(in_int2); } }
...
ztf_Float2* ztf_float2_new(float const* in_float_array)
{
	...
	return new float2(in_float_array[0], in_float_array[1]);
}
